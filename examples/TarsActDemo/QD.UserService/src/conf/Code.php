...
class Code
{
    ...
    const USER_INFO_CHECK_SESSION_FAILED = 1101;
    const USER_INFO_INVALID_PASSWORD = 1102;
    ...
    public static $msgs = [
        ...
        self::USER_INFO_CHECK_SESSION_FAILED => 'Session检查失败',
        self::USER_INFO_INVALID_PASSWORD => '密码或id错误',
    ];
}